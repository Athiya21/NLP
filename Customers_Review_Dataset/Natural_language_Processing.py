...
dataset = pd.read_csv(r"C:\Users\FATHIMA\Desktop\Datasceience_NareshIT\May\5th,6th  - NLP project\MYWORK\Customers_Review_Dataset\Restaurant_Reviews.tsv", delimiter = '\t', quoting = 3)
...
#===============================================
'''
CASE STUDY --> model is overfitted & we got less accuracy 
