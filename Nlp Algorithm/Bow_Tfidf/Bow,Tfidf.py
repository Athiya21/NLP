...
df_bow = pd.DataFrame(X_bow, columns=cv.get_feature_names())
print(df_bow)
...
# Create a DataFrame to view the TF-IDF values clearly
df_tf = pd.DataFrame(X_tf, columns=tf.get_feature_names())  # Use get_feature_names() for older versions
print(df_tf)